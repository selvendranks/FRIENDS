...
module.exports.generateOtp = async(req,res)=>{
  ...
  const mailData = {
    from: process.env.EMAIL,  // sender address
      ...
      text: 'your Link',
      html: `<h2>We missed you a lot. Welocome Back ;)</h2><b><a href='https://https://grumpy-rose-slippers.cyclic.app/forgotPassword/${randomOtp}'>Reset Your password</a></b>. please dont share the link with anyone`
